                    ...
                    <dl>
                        ...
                        <dd style="margin-left:0px">
                            <ol class="contract-ol">
                                ...
                                <li>
                                    第1項に規定する通知が、規定方法以外によって行われた場合は、
                                    当該紹介はなかったものとみなし、紹介手数料を甲は乙に支払わないものとする。
                                </li>
                                <li>
                                    甲において、顧客が複数の紹介会社より紹介を受けた場合、紹介の先後にかかわらず、当該顧客に対し見学日時の設定を行った紹介会社による紹介を、紹介手数料の対象とする。
                                </li>
                                <li>
