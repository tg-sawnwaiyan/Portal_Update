            ...
            <div class="">
                <div class="row m-lr-0">
                    <div class="col-md-12 m-lr-0 p-0">
                        ...
                        <!-- slider -->
                        <div class="card-header d-sm-block tab-card-header clearfix cat-nav infoBox news-card-header" ref="infoBox">
                            <span id="left-button" class="left-arr-btn arr-btn d-none-sp" @click="swipeLeft" v-if="is_cat_slided" >
                            ...
                            <div class="nav nav-tabs card-header-tabs center no-scrollbar" id="myTab" ref="content" v-bind:style="{ width: computed_width }">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li id="top" class="nav-item nav-line tab-color0">
                                        <a id='top_a' class="nav-link nav-line" v-on:click="changeBgColor(0);" href="/">トップ</a>
                                    </li>                                
                            ...
                            <span id="right-button" class="right-arr-btn arr-btn d-none-sp" @click="swipeRight" v-if="is_cat_overflow" >
                        ...
                        <div class="row col-12 m-lr-0 p-0" v-if="status == '0' && !latest_post_null" id="view-1024">
                            <!-- category box -->
                            <div class="card col-md-12 col-lg-6 pad-new d-none d-sm-block first-child border-0">
                                        ...
                                        <div class="row">
                                            <div class="active-users col-md-6 col-sm-6">
                                                <router-link :to="'/newsdetails/'+latest_post.id">
                                                    ...
                                                    <p class="source-subtitle" v-if="latest_post.created_at">
                                                      <img v-if="latest_post.created_at" alt="" src="/images/5.png" class="source-img" @error="imgUrlAlt">
                                            ...
                                            <div class="col-md-6 col-sm-6 news-wrapper">
                                                <ul class="list-group list-group-flush all-item" v-for="post in posts" :key="post.id">
                                                    <li class="list-group-item list-group-item-padding" v-if = "posts[0].id != post.id">
                                        ...
                                        <div class="col-sm-6 m-b-8 pad-new" v-for="item in latest_post_all_cats.slice(0, 8)"  :key="item.id">
                                            <div class="col-md-12 row adslist-card news-3-card m-0" :class="item.category_id == 26?'break-news':''">
                                                ...
                                                <div class="col-md-8 col-sm-8 txt-box">                                                    
                                                    ...
                                                    <span v-if="item.category_id == 26" class="breaking-tip for-read-more bottom-0">PR</span>
                        ...
                        <svg x="0px" y="0px" width="30" height="30" viewBox="0 0 172 172" class="fill-red">
                            <g transform="">
                                <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" class="mix-blend-mode-normal">
                                    ...
                                    <path d="M86,172c-47.49649,0 -86,-38.50351 -86,-86v0c0,-47.49649 38.50351,-86 86,-86v0c47.49649,0 86,38.50351 86,86v0c0,47.49649 -38.50351,86 -86,86z" fill="none"></path>
                                    <path d="M86,168.56c-45.59663,0 -82.56,-36.96337 -82.56,-82.56v0c0,-45.59663 36.96337,-82.56 82.56,-82.56v0c45.59663,0 82.56,36.96337 82.56,82.56v0c0,45.59663 -36.96337,82.56 -82.56,82.56z" fill="none"></path><path d="M0,172v-172h172v172z" fill="none"></path>
                                    <path d="M3.44,168.56v-165.12h165.12v165.12z" fill="none"></path>
                                    <path d="M86,172c-47.49649,0 -86,-38.50351 -86,-86v0c0,-47.49649 38.50351,-86 86,-86v0c47.49649,0 86,38.50351 86,86v0c0,47.49649 -38.50351,86 -86,86z" fill="none"></path>
                                    <path d="M86,168.56c-45.59663,0 -82.56,-36.96337 -82.56,-82.56v0c0,-45.59663 36.96337,-82.56 82.56,-82.56v0c45.59663,0 82.56,36.96337 82.56,82.56v0c0,45.59663 -36.96337,82.56 -82.56,82.56z" fill="none"></path>
                                    <g fill="#666666">
                    ...
                    <div  :id="'newsChangeLink' + index" class="row m-lr-0">
                        <slick :options="slickOptions" class="news-slider-width" v-if="w_width > 480"> 
                            <div v-for="(value, block_id, i) in group" :key="i">                  
                                ...
                                <div class="pad-new pattern-child" v-if="block_id == 3">
                                    <router-link v-for="(item,inx) in value.slice(0,8)" :key="inx" :to="'/newsdetails/'+item.pid" class="color-333">
                        ...
                        <slick :options="slickOptions" class="news-slider-width" v-else>
                            ...
                            <div class="pad-new pattern-child" v-if="group[3]">
                                <router-link v-for="(item,inx) in group.slice(3, 11)" :key="inx" :to="'/newsdetails/'+item.pid" class="color-333">
                                    <p class="text-truncate news-list-display">
                                        <i class="fas fa-building"></i> {{item.main_point}}
                                    </p>
                                </router-link>
