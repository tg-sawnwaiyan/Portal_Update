        ...
        <div class="row m-0">
            ...
            <div class="col-md-12 pad-free">
                <div class="col-md-12 fav-his-header pad-free">
                    <svg x="0px" y="0px" width="24" height="24" viewBox="0 0 172 172" class="fill-00000">
            ...
            <div class="modal fade bd-example-modal-google googlecheck" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display:none;">
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <span class="job_ico"><i class="fas fa-map-marker-alt"></i></span>
                            <strong>住所</strong>
                            <br>
                            <span>{{address}}</span>
                            <hr>
                            <span class="job_ico"><i class="fa fa-map-signs"></i></span>
                            <strong>最寄り駅</strong>
                            <br>
                            <p v-html="access"></p>
                        </div>
                        ...
                        <div class="modal-body">
                            <table class="table table-bordered price_tbl test">
                                ...
                                <tbody v-for="payment in payment_name" :key="payment.id">
                                    <tr>
                                        <td>
                                            <h5>【増税対応済】{{payment.payment_name}}</h5>
                                            ...
                                            <div class="card-carousel--card--footer">
                                                ...
                                                <table class="table table-bordered">
                                                        ...
                                                        <td v-for="nur_profile in nur_profiles" :key="nur_profile.id">
                                                            <dl>
                                                                ...
                                                                <dd class="profile_price">
                                                                    ...
                                                                    <strong v-else>{{(Math.floor(Number(nur_profile.moving_in_from)/10000))==0? '' : (Math.floor(Number(nur_profile.moving_in_from)/10000)).toLocaleString()+'万' }}{{(Number(nur_profile.moving_in_from)%10000)==0 ? '' : (Number(nur_profile.moving_in_from)%10000).toLocaleString()}}円～</strong>
                                                                </dd>
                                                            </dl>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <td v-for="nur_profile in nur_profiles" :key="nur_profile.id">
                                                            <dl>
                                                                ...
                                                                <dd class="profile_price">
                                                                    ...
                                                                    <strong v-else>{{(Math.floor(Number(nur_profile.per_month_from)/10000))==0? '' : (Math.floor(Number(nur_profile.per_month_from)/10000)).toLocaleString()+'万' }}{{(Number(nur_profile.per_month_from)%10000)==0 ? '' : (Number(nur_profile.per_month_from)%10000).toLocaleString()}}円～</strong>
                                                                </dd>
                                                            </dl>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td v-for="nur_profile in nur_profiles" :key="nur_profile.id">
                                                            <div class="profile_wd">
                                                                <span class="pseudolink" @click="monthlyCost(nur_profile.id)" data-toggle="modal" data-target=".bd-example-modal-cost" data-backdrop="static" data-keyboard="false"><i class="fa fa-search m-r-5"></i>料金プランの詳細</span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
