      ...
      <div class="col-md-12 pad-free">
            ...
            <td>
              <div class="form-group m-b-0">
                  ...
                  <div class="col-xl-10 col-md-12 float-right clinical-subject-toggle-div toggle-div m-t-10">                        
                    <div class="row"> 
                      <div v-for="subj in clinical_subj" :key="subj.id" class="form-check form-check-inline col-6 col-md-4 col-lg-3">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="row">
                            ...
                            <div class="col-lg-6 m-t-768">
                              <span>まで</span>
                              <input type="text" class="form-control am-to1 white-bg-color" placeholder="0:00"  v-model="schedule_arr.am_tue_to"/>
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="row">
                            <div class="col-lg-6">
                              <span>から</span>
                              <input type="text" class="form-control pm-from1 white-bg-color" placeholder="0:00" v-model="schedule_arr.pm_tue_from"/>
                            </div>
                            <div class="col-lg-6 m-t-768">
                              <span>まで</span>
                              <input type="text" class="form-control pm-to1 white-bg-color" placeholder="0:00" v-model="schedule_arr.pm_tue_to"/>
                            </div>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <div class="row">
                            <div class="col-lg-6">
                              <span>から</span>
                              <input type="text" class="form-control am-from2 white-bg-color" placeholder="0:00" v-model="schedule_arr.am_wed_from"/>
                            </div>
                            <div class="col-lg-6 m-t-768">
                              <span>まで</span>
                              <input type="text" class="form-control am-to2 white-bg-color" placeholder="0:00" v-model="schedule_arr.am_wed_to"/>
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="row">
                            <div class="col-lg-6">
                              <span>から</span>
                              <input type="text" class="form-control pm-from2 white-bg-color" placeholder="0:00" v-model="schedule_arr.pm_wed_from"/>
                            </div>
                            <div class="col-lg-6 m-t-768">
                              <span>まで</span>
                              <input type="text" class="form-control pm-to2 white-bg-color" placeholder="0:00" v-model="schedule_arr.pm_wed_to"/>
                            </div>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <div class="row">
                            <div class="col-lg-6">
                              <span>から</span>
                              <input type="text" class="form-control am-from3 white-bg-color" placeholder="0:00" v-model="schedule_arr.am_thu_from"/>
                            </div>
                            <div class="col-lg-6 m-t-768">
                              <span>まで</span>
                              <input type="text" class="form-control am-to3 white-bg-color" placeholder="0:00" v-model="schedule_arr.am_thu_to"/>
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="row">
                            <div class="col-lg-6">
                              <span>から</span>
                              <input type="text" class="form-control pm-from3 white-bg-color" placeholder="0:00" v-model="schedule_arr.pm_thu_from"/>
                            </div>
                            <div class="col-lg-6 m-t-768">
                              <span>まで</span>
                              <input type="text" class="form-control pm-to3 white-bg-color" placeholder="0:00" v-model="schedule_arr.pm_thu_to"/>
                            </div>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <div class="row">
                            <div class="col-lg-6">
                              <span>から</span>
                              <input type="text" class="form-control am-from4 white-bg-color" placeholder="0:00" v-model="schedule_arr.am_fri_from"/>
                            </div>
                            <div class="col-lg-6 m-t-768">
                              <span>まで</span>
                              <input
        ...
        <div class="form-group form-group-wrapper">
          ...
          <div id="changeGalleryLink" class="row col-12 m-0 photo-toggle-div pad-free">
            <div class="col-12 col-lg-12 float-right p-0">
              <span class="galleryadd btn all-btn main-bg-color float-right nursing_add_responsive min-width-0" @click="galleryAdd()">
        ...
        <div class="form-group form-group-wrapper">
          ...
          <div id="changeGalleryVideoLink" class="row col-12 m-0 p-0 video-toggle-div">
            <div class="col-12 col-lg-12 float-right p-0">
              <span class="galleryvideo btn all-btn main-bg-color float-right nursing_add_responsive min-width-0" @click="galleryVideoAdd()" >
