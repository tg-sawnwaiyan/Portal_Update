<template>
  <div id="Profile-page">
    <h4 v-if="login_person == 'customer' && visit == 'false'" class="header h4-background">{{heading}}</h4>
    <button @click="$router.go(-1)" v-if="login_person == 'admin' && visit == 'false'" class="btn btn-danger all-btn submit admin-backbtn float-r">
