                            ...
                            <form  class="m-t-16 sendEmail comform comment" autocomplete="off">
                                <div class="form-group row">
                                    <div class="col-sm-4 text-left">
                                        <label for ="title"  >
                                            <strong> 口コミタイトル &nbsp;<span class="error sp1">必須</span></strong>
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <input type="title"  class="form-control box " id="title"  name="title" v-model="comments.title">
                                        <div v-if="errors.title" class="errors_color">{{ errors.title }}</div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-4 text-left">
                                        <label for ="email" >
                                            <strong> メールアドレス（半角英数字）&nbsp;<span class="error sp1">必須</span>
                                            </strong>
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <input type="email"  class="form-control box " id="email"  name="email" v-model="comments.email">
                                        <div v-if="errors.email" class="errors_color">{{ errors.email }}</div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-4 text-left">
                                        <label for ="name"  >
                                            <strong> お名前&nbsp;<span class="error sp1">必須</span></strong>   
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <input type="name" class="form-control box " id="name"  name="name" v-model="comments.name">
                                        <div v-if="errors.name" class="errors_color">{{ errors.name }}</div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-4 text-left">
                                        <label for ="year"  ><strong> 生まれた年</strong>
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div v-if="errors.comment" class="errors_color">{{ errors.comment }}</div>
                                    </div>
                                </div>                                        
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <router-link to="/privacyPolicy" class="pseudolink">
