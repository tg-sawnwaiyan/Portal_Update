        ...
        <div>
          <div class="row map-wrap">
            <div class="col-lg-5 col-md-12 col-sm-12 float-left map-leftwrapper">
              <h2 class="map-header hospital-map-header" style="bottom: 155px;">
                赤ちゃんからおと<br/>なまでみんなで通<br/>える街の名医が見<br/>つかります。
              </h2>
              <!--search input-->
              <div class="wrap">
                <div class="search">
                  ...
                  <div class="row">
                    <div id="job_detail" class="col-md-12 col-sm-12 pad-free offset" style="margin-top:20px;" v-for="(hos,index) in displayItems" :key="hos.hos_id">
                      <div class="hos-content">
                        ...
                        <div class="mt-4 detail-btn text-center">
                          <router-link :to="{ path:'/profile/hospital/'+ hos.hos_id}" class="btn all-btn">詳細を見る</router-link>
                        </div>
                      </div>
                    </div>
                  </div>
