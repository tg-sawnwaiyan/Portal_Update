            ...
            <div class="row m-lr-0 mb-3" v-for="news in newdetails" :key="news.id">             
              <div class="col-md-12" >
                ...
                <div class="news-createdby-com">
                  <span v-if="news.created_by_company">
                ...
                <div class="set-date">
                  <p :class="news.cat_id == 26 ? 'title26':'title'+(5-(Math.floor(news.cat_id%5)))">
                    ...
                    <small class="color-aaa"  v-if="news.cat_name != 'PR'" >
              ...
              <div class="col-12">
                <div class="float-left mr-4 newsDetail_leftwrapper">              
                  <div class="img-wrap mb-2" v-if="!noimage" >
                    <img :src="'/upload/news/'+ news.photo"  class="img-responsive img_2 max-width-100" alt="img" @error="imgUrlAlt" />
                  </div>                   
              ...
              <span v-if="news.created_by" class="news-createdby">
                {{news.created_by}}
              </span>                
            </div>            
            <section v-for="news in newdetails" :key="news.id">
              <div v-if="news.cat_name != 'PR'">
                <div class="row col-md-12 m-lr-0 m-t-15" v-if="latest_post_all_cats.length > 0">   
                  <div  class="row col-md-12 text-center m-lr-0 pad-free latest-post-all-cats" v-if="latest_post_all_cats.length != 0">
                    <h4 class="h4 next-title related-news">関連ニュース</h4>
                  </div>
                  <div class="related_content">
                    <div class="related_box mt-2" v-for="latest_post_all_cat in latest_post_all_cats" :key="latest_post_all_cat.id" >
                      <router-link :to="'/newsdetails/'+ latest_post_all_cat.id">
                        <div class="hovereffect fit-image cursor-pointer">
