...
<layout>
<div>
    <div class="col-md-12 nursing-search">
        <h5 class="font-weight-bold"><i class="fas fa-map map-color"></i>&nbsp;地図検索 
            ...
            <div class="col-md-12" id="scrollMap">
                <div>
                    ...
                    <div id="scroll-responsive">
                        <div class="select select-justify" id="filter">
                            <h5 class="profile_header profile-header-border">現在の検索条件</h5>                           
                            <div class="row">
                                <div class="col-lg-5 col-md-6 m-b-414">
                                    ...
                                    <div class="card search-border-dash">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-6"> 
                                                    <select id="selectCity" class="form-control custom-select bg-fff" @change="nursingSearchData(1);" v-model="id">
                                                        <option value="-1" disabled>▼市区町村</option>
                                                        <option  :value="city.id" v-for="(city,index) in cities" :key="index" >{{city.city_name}} </option>
                                                    </select>
                                                </div>
                                                <div class="col-lg-6">
                                                    <select id="selectTownship" class="form-control custom-select nus-town-m-t bg-fff" @change="nursingSearchData(2);" v-model="township_id">
                                    ...
                                    <div class="card search-border-dash">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <select name="" id="" class="form-control custom-select nus-town-m-t bg-fff" @change="nursingSearchData()" v-model="per_month">
                                ...
                                <div class="col-lg-2 col-md-4 m-b-414 pc-768 align-self-center m-t-30">
                                    <span class="btn seemore-btn select all-btn show-search-map" id="showSearchMap" @click="showSearchMap"><i class="fas fa-exchange-alt"></i>&nbsp;都道府県を再選択する</span>                                    
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row" >
                            <div class="col-sm-12 col-md-12">                                
                                <div class="m-t-10 m-b-10">
                                    <div v-if="loading" class=" m-t-10 m-b-10 map-loading">
                                        <div class="lds-ripple m-t-10 m-b-10 lds-ripple-size">
                                            <div>
                                                <div></div><div></div>
                                            </div>
                                        </div>
                                        <div class="col-12 overlay overlay-z-index"> ffff</div>
                                    </div>
                                    <div id="mymap" ></div>
                                </div>
                        ...
                        <div class="row" >
                                                        ...
                                                        <tr >
                                                            <td class="pt-2 pb-2"  v-for="(items,index) in nus_data" @mouseover="mouseover(items.alphabet)" @mouseleave="mouseleave(items.alphabet)" :id="items.alphabet" :key="items.nursing_id">
                                                                <div class="wd-in">
                                                                    ...
                                                                    <p class="item-fav btn btn-sm" v-if="items.fav_check == '' && !$auth.check()" :class="'view_pro_id'+items.nursing_id" @click="favAddFun('add',items.nursing_id,index);">
                                                                        <i class="fas fa-plus-square color-c40000"></i> お気に入りに追加 {{items.fav_check}}
                                                                    </p>

                                                                    <p class="item-fav btn btn-sm color-aaa" v-if="items.fav_check == 'check' && !$auth.check()" :class="'done_pro_id'+items.nursing_id" @click="favAddFun('remove',items.nursing_id,index);">
                                                                        <i class="fas fa-check-double color-c40000"></i>&nbsp; 追加済み
                                                                    </p>
                                                                    ...
                                                                    <p class="item-name"><img :src="'http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld='+items.alphabet+'|fd0e0e|ffffff'" alt="">
                                                                        <router-link :to="{ path:'/profile/nursing/'+items.nursing_id}" class="pseudolink pseudolink-color">{{items.name}}</router-link>
                                                                    </p>
                                                                
                                                                    <p>{{items.city_name}} <i class="fas fa-angle-double-right double-right-color"></i> {{items.township_name}}</p>
                                                                </div>                                                        
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td  v-for="items in nus_data" @mouseover="mouseover(items.alphabet)" @mouseleave="mouseleave(items.alphabet)" :id="items.alphabet" :key="items.nursing_id">
                                                                <div class="wd-in">
                                                                    ...
                                                                    <div class="row m-t-10 m-b-10">
                                                                        <div class="col-5 col-lg-5 col-sm-6 carousel-padding">
                                                            ...
                                                            <td  v-for="items in nus_data" @mouseover="mouseover(items.alphabet)" @mouseleave="mouseleave(items.alphabet)" :id="items.alphabet" :key="items.nursing_id">
                                                                <div class="wd-in">
                                                                    <table class="table table-bordered price-tbl text-center">
                                                                        <thead>
                                                                            <tr>
                                                                                <th class="text-center th-bg">入居時費用</th>
                                                                                <th class="text-center th-bg">月額費用</th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody>
                                                                            <tr>
                            ...
                            <div id="filtertable" class="col-12">
                                <table class="table table-bordered col-12 box-wrap">
                                    <tbody>                                        
                                        <tr>                                           
                                            <th class="pc-414-table sp-768-block move-in-condition" v-if="showOne">入居時の条件</th>
                                            <td class="sp-768-block sp-414-table" v-if="showOne">
                                                <!--入居時の条件から探す-->
                                                <div class="dropdown search_rsp">
                                                    <button type="button" class="btn btn-default btn-sm dropdown-toggle sp-414 search-dropdown" data-toggle="dropdown">
                                                        入居時の条件から探す
                                                    </button>
                         ...
                         <span v-if="norecord_msg">
                            <div class="container-fuid m-t-20">
                                <p class="nosearch-icon">
                                    <svg x="0px" y="0px" width="30" height="30" viewBox="0 0 172 172" class="fill-red">
                                        <g transform="">
                    ...
                    <div class="">
                        <div class="row">
                            <div class="col-lg-6 col-md-12 col-slg-12 margin-top-20" v-for="(nus,index) in displayItems" :key="nus.id">
                                <div class="nur-content">
                                    <div class="job-header">
                                        <div class="row pad-free">
                                            <div class="col-lg-9 col-sm-9">
                                                ...
                                                <h5 class="nur-tit">
                                                    <router-link :to="{ path:'/profile/nursing/'+ nus.nursing_id}" class="pseudolink">{{nus.name}}</router-link>
                                                </h5>                                                                                  
                                                <div class="d-flex sp-414" id="sp-414-block">
                                                    ...
                                                    <span v-if="nus.date_of_establishment" class="nur_date">
                                                        <span>開設年月日 :</span> 
                                                        {{nus.date_of_establishment}}
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-sm-3 text-right pc-768">
                                                <span class="btn fav-profile fav-item fav-color" v-if="nus.fav_check == '' && !$auth.check()" :class="'view_pro_id'+nus.nursing_id" @click="favAddFun('add',nus.nursing_id,index);">
                                                    <i class="fas fa-plus-square color-c40000"></i>
                                                    &nbsp; お気に入りに追加
                                                </span>
                                                <span class="btn fav-profile fav-item fav-color color-aaa" v-if="nus.fav_check == 'check' && !$auth.check()" :class="'done_pro_id'+nus.nursing_id" @click="favAddFun('remove',nus.nursing_id,index);">
                                    ...
                                    <p class="m-b-10"><span class="job_ico"><i class="fa fa-map-signs"></i></span>{{nus.city_name}} <i class="fas fa-angle-double-right double-right-color"></i> {{nus.township_name}} </p>                                                            
                                    ...
                                    <div class="job-body row  clearfix">
                                        <div class="col-md-4 col-sm-12 job-img">
                                            ...
                                            <div class="mt-4 col-12 detail-btn text-center pc-768">
                                                <router-link :to="{ path:'/profile/nursing/'+ nus.nursing_id}" class="btn all-btn font-weight-bold">詳細を見る</router-link>
                                            </div>
                                        </div>
                        ...
                        infoWindowContent.push([
                            ...
                            '<div class="">' +
                                ...
                                '<thead>' +
                                    ...
                                    '</tr>' +
                                    '<tr>' +
                                    '<td colspan="2"><p class="job_id search_jobid profile-number"><span> 施設番号:' +
                                ...
                                '<tbody>' +
                                    '<tr>' +
                                    '<td colspan="2" class="text-left padding-bottom-0">' +
                                ...
                                '<td colspan="2" class="padding-top-0">' +
                                    '<div class="">' +
                                    '<table class="table table-bordered price-tbl text-center margin-bottom-0">'+
                                    '<thead><tr><th class="text-center th-bg">入居時費用</th><th class="text-center th-bg">月額利用料</th></tr></thead>'+
                                    '<tbody>'+
