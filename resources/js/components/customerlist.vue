                ...
                <div v-else class="container-fuid">
                    ...
                    <div class="row mb-4 advanced-search">
                        ...
                        <div class="col-xl-5 col-md-13 p-t-1024 form-check form-check-inline choose-item m-t-10">
                            <label class="form-check-label control control--checkbox check-label">
                                <input type="checkbox" class="form-check-input" value="1"   v-model="recordstatus" @change="searchCustomer()">
                                有効
                                <div class="control__indicator"></div>
                            </label>
                            <label class="form-check-label control control--checkbox check-label" @change="searchCustomer()">
                                        ...
                                        <div class="col-sm-12 p-0">
                                            ...
                                            <div class="row boot-xl">
                                                ...
                                                <div class="col-xl-11 col-lg-10 col-md-8">
                                                    <span class="pc-414-inline">: &nbsp;</span>{{customer.name}}
                                                </div>
                                            </div>
                                            <div class="row boot-xl">
                                                <div class="col-xl-1 col-lg-2 col-md-4 custom_title">
                                                ...
                                                <div class="col-xl-11 col-lg-10 col-md-8" v-if="customer.status == 0" >
                                                    <span class="pc-414-inline">: &nbsp;</span>登録承認審査中
                                                </div>
                                                <div class="col-xl-11 col-lg-10 col-md-8" v-else>
                                                    <span class="pc-414-inline">: &nbsp;</span>
                                            ...
                                            <div class="row boot-xl">
                                                ...
                                                <div class="col-xl-11 col-lg-10 col-md-8">
                                                    <span class="pc-414-inline">: &nbsp;</span>{{customer.email}}
                                                </div>
                                            </div>
                                            <div class="row boot-xl">
                                                <div class="col-xl-1 col-lg-2 col-md-4 custom_title">
                                                ...
                                                <div class="col-xl-11 col-lg-10 col-md-8">
                                                    <span class="pc-414-inline">: &nbsp;</span>{{customer.phone}}
                                                </div>
                                            </div>
                                            <div class="row mt-3">
                                                <div class="col-md-12">
                                                    ...
                                                    <span v-else class="">
                                                        ...
                                                        <p class="mt-2 p-style" v-if="customer.status == 1"><i class="fa fa-check-circle" aria-hidden="true"></i>&nbsp;この事業者は登録承認済です。</p>
                                                        <p class="mt-2 p-style2" v-if="customer.status == 2"><i class="fa fa-check-circle" aria-hidden="true"></i>&nbsp;この事業者は登録不許可です。</p>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>                                        
