    ...
    <div id="app">
        <div v-if="type == 'nursing'" id="nursingView">         
            ...
            <div v-if="$auth.user().role == 2">
                <div @click="$router.go(-1);" class="pc-2000 profile-publish-1">
                ...
                <div class="pc-991-1880">
                    <span @click="$router.go(-1);" class="backbtn profile-publish-2">
                    <span class="btn btn-danger all-btn submit">
                            <i class="fas fa-arrow-left"></i> 
                            <span>戻る</span> 
                        </span> 
            ...
            <h4 class="profile-tit"  v-if="!currentPanoImage && nus_pro[0]">
                ...
                <span class="customer-id pc-991-1880">施設番号:{{profilenumber}}</span> 
            </h4>
            <div class="col-12 detail_profile_left pad-free"  v-if="currentPanoImage">
                <h4 class="profile-tit" v-if="nus_pro[0]">{{nus_pro[0].name}}</h4>
                <div class="thumbnail-img pc-414 profile-publish-3">
                    <div class="card-carousel profile-publish-4">
                        <div class="card-img">
                    ...
                    <div class="col-md-5 detail_profile_left col-slg-12 pad-free-750">
                        <div class="col-12 pad-free sp-1024">
                            <h5 class="profile_header">
                                ...
                                <div class="d-block float-right pc-414" v-if="loginuser=='false'">
                                    <div class="m-r-10 float-left">
                                        <span class="bottom-fav-btn" v-if="!view_pro_id && loginuser=='false'" @click="favAddFun('add');view_pro_id = !view_pro_id">
                                            <i class="fas fa-plus-square color-c40000"></i>
                                            &nbsp; お気に入りに追加
                                        </span>
                                        <span class="bottom-fav-btn color-aaa" v-if="view_pro_id && loginuser=='false'" @click="favAddFun('remove');view_pro_id = !view_pro_id">
                                            <i class="fas fa-check-double  color-c40000"></i>
                                            &nbsp; 追加済み
                                        </span>
                                    </div>
                                    <div class="float-right">
                                        <span class="" v-if="loginuser=='false' && !$auth.check() && type == 'nursing'">       
                                            <span class="bottom-mail-btn" @click="documentPost()">
                                                <i data-v-b65423c6="" class="far fa-envelope color-fff"></i>
                                                &nbsp;資料請求
                                            </span>
                                        </span>
                                    </div>
                            ...
                            <section class="row col-12 m-0 p-0">
                                <div class="d-block float-right ml-0 m-b-20 sp-414" v-if="loginuser=='false'">
                                    <div class="m-r-10 float-left">
                                        <span class="bottom-fav-btn" v-if="!view_pro_id && loginuser=='false'" @click="favAddFun('add');view_pro_id = !view_pro_id">
                                            <i class="fas fa-plus-square color-c4000"></i>
                                            &nbsp; お気に入りに追加
                                        </span>
                                        <span class="bottom-fav-btn  color-aaa" v-if="view_pro_id && loginuser=='false'" @click="favAddFun('remove');view_pro_id = !view_pro_id">
                                            <i class="fas fa-check-double color-c4000"></i>
                                            &nbsp; 追加済み
                                        </span>
                                    </div>
                                    <div class="float-right">
                        ...
                        <div class="sp-414 res-pano m-b-10"  v-if="images.length > 0">
                            <slick :options="slickOptions" ref="slickSetting1">
                                <div>
                                    <h2><img :src="'/upload/nursing_profile/' +currentImage" alt="" @error="imgUrlAlt" class="img-fluid"></h2>
                                </div>
                            </slick>
                            <slick>
            ...
            <div class="ele m-lr-0" id="element2">
                <h5 class="profile_header">
                    ...
                    <div class="d-block float-right pc-414" v-if="loginuser=='false'">
                        <div class="m-r-10 float-left">
                            <span class="bottom-fav-btn" v-if="!view_pro_id && loginuser=='false'" @click="favAddFun('add');view_pro_id = !view_pro_id">
                                <i class="fas fa-plus-square color-c40000"></i>&nbsp; お気に入りに追加
                            </span>
                            <span class="bottom-fav-btn color-aaa" v-if="view_pro_id && loginuser=='false'" @click="favAddFun('remove');view_pro_id = !view_pro_id">
                                <i class="fas fa-check-double color-c40000"></i>
                                &nbsp; 追加済み
            ...
            <div class="ele m-lr-0" id="element3">
                ...
                <div v-else class="row col-12 m-0 m-b-768"> 
                    <p class="no-data-color">データがありません。</p> 
                </div>
                <!--Table responsive-->
                ...
                <div class="row col-12 m-0 p-0">
                    ...
                    <div class="col-md-12 pad-free-750">
                        ...
                        <div class="row gallery-list m-0 pad-free-750" v-else>
                            <div v-for="(video) in  videos" :key="video.id" class="col-6  col-sm-4 col-md-4 col-lg-3 m-b-10 width-100">
                                <div class="gallery-item height-135">
                    ...
                    <div class=" col-12 pad-free-750">
                        ...
                        <div v-else class="col-12 m-b-768"> 
                            <p class="no-data-color">データがありません。</p> 
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex d-block">
                                ...
                                <p class="comment-date">
                                    ...
                                    <span class="ml-2"><i class="fa fa-clock" aria-hidden="true">
                                        </i> {{comment.created_time}}
                                    </span>
                                </p>
                            </div>
                            <read-more more-str="もっと見る" :text="comment.comment" :max-chars="160" class="m-t-comment"></read-more>
                            <br>
                            <div>{{comment.customer}}</div>
                        </div>
                    </div>
                    <div class="m-b-20 text-right">
                        <router-link :to="{ path:'/comment/nursing/'+ pro_id}" class="comment-btn" v-if="show_comment">
        ...
        <div v-if="type == 'hospital'" id="hospitalView">
            ...
            <div class="ele m-lr-0 pt-2" id="element7">
                ...
                <div class="row col-12 list-wrap m-lr-0 white-bg-color" v-for="cust in hospitals" :key="cust.id">
                    ...
                    <div class="col-md-5 col-slg-12 col-sm-12 detail_profile_left pad-free-750">                        
                        ...
                        <div class="sp-414 res-pano m-b-10"  v-if="images.length > 0">
                            <slick :options="slickOptions" ref="slickSetting1">
                                <div>
                                    <h2>
                                        <img :src="'/upload/hospital_profile/' +currentImage" alt="" @error="imgUrlAlt" class="img-fluid">
                                    </h2>
                                </div>
                            </slick>
                            <slick>
                    ...
                    <div class="col-md-7 col-sm-12 detail_profile_right col-slg-12 pad-free-750">
                                    ...
                                    <h5 class="profile_header">
                                        ...
                                        <div class="d-block float-right" v-if="loginuser=='false'">
                                            ...
                                            <div class="float-right">
                                                <span class="" v-if="loginuser=='false' && !$auth.check() && type == 'nursing'">       
                                                    <span class="bottom-mail-btn" @click="documentPost()">
                                                        <i data-v-b65423c6="" class="far fa-envelope color-fff">
                                                        </i>&nbsp;資料請求
                                                    </span>
                                                </span>
                                            </div>
                        ...
                        <div class="row m-lr-0 m-b-768" v-else> 
                            <p class="no-data-color">データがありません。</p>
                        </div>                       
                    </div>
                    <!--end for address-->
            ...
            <div class="col-md-12 pad-free-750">
                <h5 class="profile_subtit">動画</h5>
                <div class="row m-0 gallery-list width-100" v-if="videos.length>0">
            ...
            <div class="row ele m-lr-0" id="element9">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 pad-free-750"  v-if="displayItems.length>0">
                    ...
                    <div class="m-b-20 text-right">
                        <router-link :to="{ path:'/comment/hospital/'+ pro_id}" class="comment-btn" v-if="show_comment"> 
                            <i class="far fa-comment"></i>
                            <span>口コミを投稿する</span>
                        </router-link>
                    </div>
