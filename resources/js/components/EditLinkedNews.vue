                    ...
                    <div class="col-md-12">
                        <form @submit.prevent="updateAds" autocomplete="off">
                            <div class="form-group">
                                <label class="lb-style">日付&nbsp;<span class="error sp2">必須</span></label><br>
                                <date-picker class="date-picker-style"  :lang="lang" valueType="format" v-model="newsByCat.post_date" placeholder="日付を選択してください"></date-picker>
                                <span v-if="errors.post_date" class="error">{{errors.post_date}}</span>
                            </div>
                            <div class="form-group">
                                <label>カテゴリー &nbsp;<span class="error sp2">必須</span></label><br>
                                <select v-model="newsByCat.type" class="form-control newsByCat-style" @change='getstates()'>
                            ...
                            <div class="form-group">
                                ...
                                <select v-model="newsByCat.status" class="form-control newsByCat-style" @change='getstates()'>
