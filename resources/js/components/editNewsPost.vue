                    ...
                    <div v-if="selectedValue == 26" class="form-group">
                        <div class="row">
                            <div class="col-12 col-sm-4 col-md-4">
                                ...
                                <date-picker class="w-full" :lang="lang"  valueType="format" v-model="news.from_date"></date-picker>
                                <span v-if="errors.from_date" class="error">{{errors.from_date}}</span>
                            </div>
                            <div class="col-12 col-sm-4 col-md-4 mt-567-10">
                                <label>掲載終了日 </label>
                                <date-picker class="w-full"  :lang="lang" valueType="format" v-model="news.to_date"></date-picker>
                            </div>
                        </div>
                    ...
                    <div v-if="selectedValue != 26" class="form-group">
                        ...
                        <div class="card related-card">
                            <div class="card-body">
                                ...
                                <div v-if="nosearch_msg" class="card card-default card-wrap nosearch_msg">
                                    <p class="record-ico">
