...
<div id="job-search-ui" class="tab_pane_02"> 
  <div class="col-md-12" style="border-bottom: 1px dashed #828282;padding-bottom: 10px; margin-bottom: 20px;">
    <h5 class="font-weight-bold">
      <i class="fas fa-map" style="color:#828282;"></i>
      &nbsp;地図検索
        ...
        <div>
          ...
          <div class="row map-wrap" style="background-color:#ececec;">
            ...
            <div class="col-lg-5 col-md-12 col-sm-12 float-left map-leftwrapper">
              <h2 class="map-header job-map-header" style="bottom: 155px;">
            ...
            <div class="freeword-responsive">
              <h3 class="map-resicon">
                <div class="map-text-wrapper">
                  <div>
                    <p class="text-left job-map-header">
                      &nbsp;あなたのやさしい 手を求めてる老人<br class="pc-768"/>ホーム・病院が見つかります。
                    </p>
                  </div>
                </div>
              </h3>
                  ...
                  <tbody>
                    ...
                    <tr class="text-center" >
                      <td colspan="2" style="border:none;">
                        <button class="main-bg-color create-btn all-btn col-lg-2 col-md-4 col-sm-2" @click="search">
                          <i class="fas fa-search"></i>&nbsp; 検索 
                        </button>
                      </td>
                    </tr>
              ...
              <span  class="col-12" v-if="norecord_msg">
                <div class="container-fuid m-t-20">
                  <p class="nosearch-icon">
                    <svg x="0px" y="0px" width="30" height="30" viewBox="0 0 172 172" style=" fill:red;">
                      <g transform="">
...
<div v-if="linkednews.length > 0" class="container_news job_container_news">
  <div class="row-2">
    ...
    <div class="button-year" v-for="(year_arr, index) in yeararr" :key="index">
      <button type="button" :class="{ 'active' : year_arr == c_year}" class="btn btn-outline-dark btn-lg btn-2020" @click="showDataByYear(year_arr)" v-bind:id="year_arr">
        {{year_arr}}年
      </button>
    </div>
