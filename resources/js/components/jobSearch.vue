  ...
  <div class="search-map card-body" @mouseover="getStateHover">
    <div class="row" id="hos">
      <div class="col-md-12">
        <div>
          <!--start map-->
          <div class="row map-wrap bg-color-ececec">
            <!-- free word left wrapper--->
            <div class="col-lg-5 col-md-12 col-sm-12 float-left map-leftwrapper">
              <h2 class="map-header job-map-header bottom-155">
                あなたのやさしい<br/>手を求めてる老人<br/>ホーム・病院が見<br/>つかります。
              </h2>
              <!--search input-->
              <div class="wrap">
                <div class="search">
                    <input type="text" class="searchTerm search-term-border" id="search-free-word" placeholder="地名、求人タイトルなどを入力">
                    <button type="submit" class="searchButton search-button" @click="searchfreeword">
          ...
          <div id="scroll-responsive">
            <div id="job_search" class="row jobselect">              
              <div class="col-12">
                <h5 class="profile_header m-t-10 current-search">現在の検索条件</h5>
                <table class="table table-bordered col-12 border-none">
                  <tbody>
                      ...
                      <td class="sp-768-block">
                        <div class="row mt-2 mb-2">
                          ...
                          <div class="col-lg-3 col-md-4 col-sm-12 pc-414">
                            <button @click="toggleContent4" class="btn seemore-btn all-btn" v-if="getTownships.length > 0">
                              ...
                              <span id="close6">
                                <i class="fas fa-arrow-circle-up"></i> 市区町村エリアを閉じる 
                              </span>
                            </button>
                          </div>
                        </div>
                        <div class="toBeToggled4" id="toBeToggled4">
                          <div class="dropdown search_rsp">
                            <button type="button" class="btn btn-default btn-sm dropdown-toggle sp-414 search-rsp-btn" data-toggle="dropdown">
                              市から探す
                            </button>
                    ...
                    <tr >
                      <th class="pc-414-table sp-768-block padding-10">雇用形態</th>
                      <td class="sp-768-block">
                        <!--雇用形態から探す-->
                        <div class="dropdown search_rsp">
                          <button type="button" class="btn btn-default btn-sm dropdown-toggle sp-414 search-rsp-btn" data-toggle="dropdown">
              ...
              <div id="scroll" class="col-12">
                <div class="row pad-free m-b-10">
                  <div id="job_detail" class="col-lg-6 col-md-12 margin-top-20" v-for="(job,index) in displayItems" :key="index+'-'+job.title+'-'+job.jobid">
