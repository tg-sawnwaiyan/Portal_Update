<template>
    <div>
        <div id="main" class="pad-free" :class="[!$auth.check() ? inner : (visit == 'true'?inner:full),this.$route.name == 'profile'? footermargin : '']" v-if="this.$route.path !== '/register' && this.$route.path !== '/login' && this.$route.path !== '/reset' && this.$route.path !== '/resetpassword' && this.$route.path !== '/Unauthorized' && this.$route.path !== '/admin_login' && this.$route.path !== '/admin/t_is_admin_register' && this.$route.path !== '/admin/create' && this.$route.name !== 'adminedit' && this.$route.name !== '404' && this.$route.path !== '/feed/smartnews.xml'" >
